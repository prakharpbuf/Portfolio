...
?>
    ...
    <section id="Profile">
        <br>
        <h1>
            <strong>Here's my profile...</strong>
        </h1>
        <br>
        Hi, I'm Prakhar Paw... <br>
        The content in this website is yet to be filled in but you are welcome to check out the layout!! <br>
        ...
        <br> <br> 
        <button id="knowMore">Download resume</button> &nbsp;(PDF)
        <br> <br> <br>
    </section>
    </header>
    <script>
    ...
    <div class="Skill"><i class="icon fas fa-code fa-2x"></i><span class="Description"><strong>MS Access and other MS Office software</strong> <br>  Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ut tellus ac ligula<span id='dots_8'>....</span> <span id='more_8'>mattis rutrum vel et massa. Class aptent
    ...
    <section id="Projects">
        ...
        <button class="viewWork" onclick="window.location.href='#'">&uarr; &nbsp; TOP &nbsp; &uarr;</button>
    </section>
    <footer id="Contact">
        ...
        <div id="social">
            ...
            <span id="FB">
               <a href="https://www.facebook.com/prakhar.paw.37"><i class="fab fa-facebook-f fa-2x"></i></a>
            </span>
            <span id="Instagram">
               <a href="https://www.instagram.com/prakhar.paw/"><i class="fab fa-instagram-square fa-2x"></i></a>
            </span>
        </div>
        <div id="copyright">
